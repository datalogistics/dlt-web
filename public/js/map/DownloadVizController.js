/*
 * Download Viz Controller
 * public/js/map
 * DownloadVizController.js
 */
...
function downloadVizController($scope,$routeParams,$rootScope,$http,UnisService,SocketService) {
  ...
  function addLocationsFromDepot(s){
    ...
    SocketService.on("eodnDownload_Nodes",function(data){
  ...
  addLocationsFromDepot(UnisService.services);
} // end controller
